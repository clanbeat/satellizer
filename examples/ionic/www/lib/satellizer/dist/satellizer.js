...
var AuthProvider = (function () {
    ...
    AuthProvider.prototype.$get = function (SatellizerShared, SatellizerLocal, SatellizerOAuth) {
        return {
            ...
            authenticate: function (name, data, options) { return SatellizerOAuth.authenticate(name, data, options); },
...
var OAuth1 = (function () {
    ...
    OAuth1.prototype.init = function (options, userData, userOptions) {
        var _this = this;
        ...
        return this.getRequestToken().then(function (response) {
            return _this.openPopup(options, response).then(function (popupResponse) {
                return _this.exchangeForToken(popupResponse, userData, userOptions);
            });
        });
    };
    ...
    OAuth1.prototype.exchangeForToken = function (oauthData, userData, userOptions) {
        var payload = angular.extend({}, userData, oauthData);
        var options = angular.extend({ withCredentials: this.SatellizerConfig.withCredentials }, userOptions);
...
var OAuth2 = (function () {
    ...
    OAuth2.prototype.init = function (options, userData, userOptions) {
        var _this = this;
        return this.$q(function (resolve, reject) {
            ...
            _this.SatellizerPopup.open(url, name, popupOptions, redirectUri).then(function (oauth) {
                ...
                resolve(_this.exchangeForToken(oauth, userData, userOptions));
            }).catch(function (error) { return reject(error); });
        });
    };
    OAuth2.prototype.exchangeForToken = function (oauthData, userData, userOptions) {
        var _this = this;
...
var OAuth = (function () {
    ...
    OAuth.prototype.authenticate = function (name, userData, userOptions) {
        var _this = this;
        return this.$q(function (resolve, reject) {
            ...
            return oauth.init(provider, userData, userOptions).then(function (response) {
                if (provider.url) {
                    _this.SatellizerShared.setToken(response);
                }
                resolve(response);
